...
public class EnviromentGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 1f)] private float curveSmothness = 0.5f;
    ...
    private void OnValidate()
    {
        ...
        for (int i = 0; i < levelLength; i++)
        {
            ...
            if( i != 0 && i != levelLength -1)
            {
                ...
                spriteShapeController.spline.SetLeftTangent(i, Vector3.left * xMultiplier * curveSmothness);
                spriteShapeController.spline.SetRightTangent(i, Vector3.right* xMultiplier * curveSmothness);
            }
        }

        //bottom right and left points
